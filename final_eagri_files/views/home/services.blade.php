...
@section('body')
    ...
    <section id="service-header" class="mt-1" style="background-image: url('{{ asset('final_eagri/img/a.jpg')}}');">
        <div class="container">
            <div class="row">
        ...
        <div class="row text-center my-4">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card mb-5 m-lg-0">
                    <img class="card-img-top" src="{{asset('final_eagri/img/a.jpg')}}">
                    <div class="card-body text-center">
                        <h3 class="card-title font-weight-bloder">HSC ICT</h3>
