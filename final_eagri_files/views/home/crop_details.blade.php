              ...
              <div class="comments-list">
                  ...
                  <div class="media">
                      <div class="media-body">
                          ...
                          <p><small><a href="">Like</a> - <a data-toggle="modal" href="#ReplyModal">Reply_confirm</a></small></p>
                      </div>
                  </div>
                  ...
                  <div class="media">
                      <div class="media-body">
                          ...
                          <p><small><a href="">Like</a> - <a href="">Reply_confirm</a></small></p>
                      </div>
                  </div>
                ...
                <div class="modal-body">
                    <form action="" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="account_pay" value="" class="form-control" placeholder="Bkash,Paypal">
                        </div>

                        <div class="form-group">
                            <label>Confirm price</label>
                            <input type="number" name="confirm_price" value="" class="form-control" placeholder="Enter confirrm price" min="1">
                        </div>
